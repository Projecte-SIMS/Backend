    ...
    <nav class="fixed top-0 left-0 right-0 z-50 bg-gray-950/80 backdrop-blur-xl border-b border-gray-800">
        <div class="mx-auto max-w-7xl px-6 lg:px-8 flex items-center justify-between h-16">
            <div class="flex items-center gap-3">
                <div class="h-10 w-10 rounded-2xl bg-white p-1 shadow-xl shadow-brand-primary-500/30">
            ...
            <div class="flex items-center gap-6">
                ...
                <a href="https://frontend-nine-orcin-waqisje40z.vercel.app/login" class="inline-flex items-center gap-2 bg-brand-primary-600 hover:bg-brand-primary-700 text-white px-5 py-2.5 rounded-2xl text-sm font-bold uppercase tracking-widest transition-all shadow-xl shadow-brand-primary-500/30 hover:shadow-brand-primary-500/50">
                    Acceder
                </a>
            </div>
        </div>
    ...
    <main class="pt-16">
        ...
        <div class="relative isolate overflow-hidden min-h-screen flex items-center">
            ...
            <div class="absolute inset-0 -z-10">
                <div class="absolute top-0 right-0 w-[800px] h-[800px] bg-gradient-to-br from-brand-primary-600/20 to-purple-700/20 rounded-full blur-3xl"></div>
                <div class="absolute bottom-0 left-0 w-[600px] h-[600px] bg-gradient-to-tr from-brand-primary-600/10 to-transparent rounded-full blur-3xl"></div>
            </div>
                ...
                <div class="lg:flex lg:items-center lg:gap-16">
                    <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:shrink-0">
                        <div class="inline-flex items-center gap-2 mb-8">
                            <span class="inline-flex items-center rounded-full bg-brand-primary-500/10 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-brand-primary-400 ring-1 ring-inset ring-brand-primary-500/30">
                                <span class="mr-2 h-1.5 w-1.5 rounded-full bg-brand-primary-400 animate-pulse"></span>
                                Sprint 5 - Producción
                            </span>
                        </div>
                        ...
                        <h1 class="text-4xl font-black tracking-tight text-white sm:text-6xl leading-tight">
                            ...
                            <span class="bg-gradient-to-r from-brand-primary-400 to-purple-400 bg-clip-text text-transparent"> inteligente</span>
                        </h1>
                        ...
                        <div class="mt-10 flex flex-col sm:flex-row items-start sm:items-center gap-4">
                            <a href="https://frontend-nine-orcin-waqisje40z.vercel.app/login" class="inline-flex items-center justify-center gap-2 bg-brand-primary-600 hover:bg-brand-primary-700 text-white px-8 py-4 rounded-2xl text-sm font-black uppercase tracking-widest transition-all shadow-xl shadow-brand-primary-500/30 hover:shadow-brand-primary-500/50 active:scale-95">
                                Iniciar Sesión
                            </a>
                        ...
                        <div class="mt-12 grid grid-cols-3 gap-8 border-t border-gray-800 pt-8">
                            <div>
                                <p class="text-3xl font-black text-brand-primary-400">IoT</p>
                                <p class="text-xs font-bold uppercase tracking-widest text-gray-500 mt-1">Tiempo real</p>
                            </div>
                            <div>
                                <p class="text-3xl font-black text-brand-primary-400">100%</p>
                                <p class="text-xs font-bold uppercase tracking-widest text-gray-500 mt-1">Eléctrico</p>
                            </div>
                            <div>
                                <p class="text-3xl font-black text-brand-primary-400">24/7</p>
                    ...
                    <div class="mt-16 lg:mt-0 lg:ml-10 flex-1">
                        <div class="relative">
                            <div class="absolute -inset-4 bg-gradient-to-r from-brand-primary-600/30 to-purple-600/30 rounded-[2rem] blur-2xl"></div>
        ...
        <div id="caracteristicas" class="py-24 sm:py-32 border-t border-gray-800">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl text-center">
                    <p class="text-xs font-black uppercase tracking-widest text-brand-primary-400 mb-4">Plataforma completa</p>
                ...
                <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
                    <dl class="grid max-w-xl grid-cols-1 gap-6 lg:max-w-none lg:grid-cols-3">
                        ...
                        <div class="bg-gray-900 rounded-[2rem] p-8 border border-gray-800 hover:border-gray-700 transition-colors">
                            <div class="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-primary-600 to-purple-700 shadow-lg shadow-brand-primary-500/30 mb-6">
        ...
        <div id="video" class="py-24 sm:py-32 border-t border-gray-800">
            <div class="mx-auto max-w-7xl px-6 lg:px-8 text-center">
                <p class="text-xs font-black uppercase tracking-widest text-brand-primary-400 mb-4">Demo</p>
                <h2 class="text-3xl font-black tracking-tight text-white sm:text-4xl">
        ...
        <div class="py-24 sm:py-32 border-t border-gray-800">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="relative bg-gradient-to-br from-brand-primary-600 to-purple-700 rounded-[2.5rem] px-8 py-16 sm:px-16 sm:py-24 overflow-hidden">
                    ...
                    <div class="relative text-center">
                        ...
                        <p class="mt-4 text-lg text-brand-primary-100 max-w-2xl mx-auto">
                            Accede a la plataforma y descubre una nueva forma de gestionar la movilidad sostenible.
                        </p>
                        <div class="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                            <a href="https://frontend-nine-orcin-waqisje40z.vercel.app/login" class="inline-flex items-center justify-center gap-2 bg-white hover:bg-gray-100 text-brand-primary-700 px-8 py-4 rounded-2xl text-sm font-black uppercase tracking-widest transition-all shadow-xl active:scale-95">
                                Acceder ahora
                            </a>
                            <a href="https://frontend-nine-orcin-waqisje40z.vercel.app/register" class="inline-flex items-center gap-2 text-white hover:text-brand-primary-100 font-bold transition-colors">
    ...
    <footer class="border-t border-gray-800">
        <div class="mx-auto max-w-7xl px-6 lg:px-8 py-12">
            <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                <div class="flex items-center gap-3">
                    <div class="h-10 w-10 rounded-2xl bg-white p-1 shadow-lg shadow-brand-primary-500/30">
                        <img src="/logo.png" alt="Fleetly Logo" class="h-full w-full object-contain" />
                    </div>
                    <span class="text-xl font-bold text-white">Fleetly</span>
                </div>
                ...
                <div class="flex items-center gap-6">
                    <a href="https://github.com/orgs/Sprint4-ProjectSIMS-Team1" target="_blank" class="text-gray-500 hover:text-brand-primary-400 transition-colors">
